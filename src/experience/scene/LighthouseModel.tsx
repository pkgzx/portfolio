...
export function LighthouseModel(props: JSX.IntrinsicElements['group']) {
    ...
    const [
        ...
        'models/happyPhoto.webp',
        'models/frontPhoto.webp',
...
useTexture.preload('models/frontPhoto.webp')
useTexture.preload('models/happyPhoto.webp')
...
useTexture.preload('models/cat.png')
